  ...
  @Previewable @State var nodes: [FileTreeNode] = [
    .folder(
      FolderNode(
        ...
        children: [
          .file(
            FileNode(name: "output_2.mp4", size: 1_900_000_000, path: ["Foo", "output_2.mp4"])),
          .folder(
            FolderNode(
              name: "subtitles",
              path: ["Foo", "subtitles"],
              children: [
                .file(
                  FileNode(
                    name: "eng_new.srt", size: 47_000, path: ["Foo", "subtitles", "eng_new.srt"])),
                .file(
                  FileNode(name: "eng.idx", size: 35_000, path: ["Foo", "subtitles", "eng.idx"])),
                .file(
                  FileNode(name: "eng.srt", size: 47_000, path: ["Foo", "subtitles", "eng.srt"])),
                .file(
                  FileNode(name: "eng.sub", size: 2_600_000, path: ["Foo", "subtitles", "eng.sub"])),
              ]
            )),
        ]
      ))
